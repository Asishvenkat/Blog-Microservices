  ...
  return (
       ...
       <div className="flex justify-center items-center min-h-screen p-4">
        ...
        <CardHeader className="text-center">
           <CardTitle className="text-2xl font-semibold">Profile
           </CardTitle>
            <CardContent className="flex flex-col items-center space-y-4">
           <Avatar
           className="w-28 h-28 border-4 border-gray-200 shadow-md cursor-pointer rounded-full overflow-hidden"
           onClick={clickHandler}>
             <AvatarImage src={user?.image} alt="profile pic" className="w-full h-full object-cover block" />
                   <input
                  type="file"
                  className="hidden"
                  accept="image/*"
